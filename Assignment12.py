...
#An access token is an object encapsulating the security identity of a process or thread.[1]
...
#[1] An access token is represented by the system object of type Token.
...
#api=tweepy.API(auth)
#tweets=api.search('#destiny',lang="en",count=3,tweet_mode="extended")
#for tweet in tweets:
 #   print("Dream")
...
#python library are requests,scrapy,wxPython,pillow,sqlAlchemy,twisted..etc..
